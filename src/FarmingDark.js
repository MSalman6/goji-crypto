            ...
            {/* <div className="nav-overlay">
                ...
                <div className="nav-wrapper d-flex align-items-end">
                    <div className="d-flex flex-column m-auto">
                        <Link to="staking-dark" className="d-block menu-a text-white">Goji Staking</Link>
                        <Link to="farming-dark" className="d-block menu-a text-white active">Goji Farming</Link>
                        <Link to="locking-dark" className="d-block menu-a text-white">Goji Lock</Link>
                        <Link to="dao-dark" className="d-block menu-a text-white">Goji Dao</Link>
                    </div>
                </div>
            </div>
                ...
                <div className="header-content position-relative">
                    <div className="main-nav">
                        <nav className="container-fluid navbar navbar-expand-lg navbar-dark w-100 main-nav d-flex p-sm-5 navbar-row" id="navbar">
                            <Link className="navbar-brand header-logo me-auto" to="dao-dark">
                            ...
                            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul className="navbar-nav m-auto mb-2 mb-lg-0 justify-content-center h-100">
                                    <li className="nav-item mx-sm-3">
                                        <Link className="nav-link d-flex" aria-current="page" to="staking-dark">Goji Staking</Link>
                                    </li>
                                    <li className="nav-item mx-sm-3">
                                        <Link className="nav-link d-flex active" aria-current="page" to="farming-dark">Goji Farming</Link>
                                    </li>
                                    <li className="nav-item mx-sm-3">
                                        <Link className="nav-link d-flex" aria-current="page" to="locking-dark">Goji Lock</Link>
                                    </li>
                                    <li className="nav-item mx-sm-3">
                                        <Link className="nav-link d-flex" aria-current="page" to="dao-dark">Goji Dao</Link>
                                    </li>
                                </ul>
                            </div>
                            <div className="d-flex w-auto d-none d-sm-flex">
                                <Link to="farming-light" className="me-3 theme-toggle d-flex align-items-center">
                            ...
                            <div className="mobile-nav-btns align-items-center mobile">
                                <Link className="theme-toggler" to="farming-light">
                                    <svg width="69" height="24" viewBox="0 0 69 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M5.66002 4.20002L6.05002 4.59002C6.44002 4.97002 6.44002 5.61002 6.05002 5.99002L6.04002 6.00002C5.65002 6.39002 5.03002 6.39002 4.64002 6.00002L4.25002 5.61002C3.86002 5.23002 3.86002 4.60002 4.25002 4.21002L4.26002 4.20002C4.64002 3.82002 5.27002 3.81002 5.66002 4.20002Z" fill="white" />
                                        <path d="M1.99 10.95H3.01C3.56 10.95 4 11.39 4 11.95V11.96C4 12.51 3.56 12.95 3 12.94H1.99C1.44 12.94 1 12.5 1 11.95V11.94C1 11.39 1.44 10.95 1.99 10.95Z" fill="white" />
                                        <path d="M12 1H12.01C12.56 1 13 1.44 13 1.99V2.96C13 3.51 12.56 3.95 12 3.94H11.99C11.44 3.94 11 3.5 11 2.95V1.99C11 1.44 11.44 1 12 1Z" fill="white" />
                                    ...
                                    <div className="curr-header pt-3">
                                        <div className="d-flex justify-content-center align-items-center">
                                            <div className="me-auto">
                                                <img src="static/img/farming-hanu-ic.svg" />
                                            </div>
                                            <div className="m-auto">
                                                <h2 className="curr-name mb-0">Farm HANU</h2>
                                            </div>
                                            <div className="ms-auto">
                                                <img src="static/img/farming-weith-ic.svg" />
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="col-sm-4 my-3">
                                <div className="curr-item stake-item px-4 py-4">
                                    <div className="curr-header pt-3">
                                        <div className="d-flex justify-content-center align-items-center">
                                            <div className="me-auto">
                                                <img src="static/img/farming-goj-ic.svg" />
                                            </div>
                                            <div className="m-auto">
                                                <h2 className="curr-name mb-0">Farm GOJ</h2>
                                            </div>
                                            <div className="ms-auto">
                                                <img src="static/img/farming-wbtc-ic.svg" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="d-flex mt-5 mb-5">
                                ...
                                <div className="curr-item stake-item px-4 py-4">
                                    <div className="curr-header pt-3">
                                        <div className="d-flex justify-content-center align-items-center">
                                            ...
                                            <div className="ms-auto">
                                                <img src="static/img/farming-dfyn-ic.svg" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="d-flex mt-5 mb-5">
                            ...
                            <div className="col-sm-4 my-3">
                                <div className="curr-item stake-item px-4 py-4">
                                    <div className="curr-header pt-3">
                                        <div className="d-flex justify-content-center align-items-center">
                                            <div className="me-auto">
                                                <img src="static/img/farming-gaba-ic.svg" />
                                            </div>
                                            <div className="m-auto">
                                                <h2 className="curr-name mb-0">Farm GABA</h2>
                                            </div>
                                            <div className="ms-auto">
                                                <img src="static/img/farming-quickswap-ic.svg" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="d-flex mt-5 mb-5">
                            ...
                            <div className="col-sm-4 my-3">
                                <div className="curr-item stake-item px-4 py-4">
                                    <div className="curr-header pt-3">
                                        <div className="d-flex justify-content-center align-items-center">
                                            <div className="me-auto">
                                                <img src="static/img/farming-mia-ic.svg" />
                                            </div>
                                            <div className="m-auto">
                                                <h2 className="curr-name mb-0">Farm MIA</h2>
                                            </div>
                                            <div className="ms-auto">
                                                <img src="static/img/farming-wmatic-ic.svg" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="d-flex mt-5 mb-5">
